...
This shows a trend over time of defects that are completed divided by
the manner in which they were completed ('Fixed','Closed','Junked','Duplicate')
...
* Disposition type is a State on the defect
* This only counts defects that were created AND completed during the time period
